...
const Form = () => {
  return(
    ...
    <Container direction='column' justify='center'>
      <Input margin='15px 0 0 95px' borderColor='#8752CC' color='#8752CC' opacity='50%' placeholder='Enter a user name' 
      placeholderTextColor='#8752CC' />
      <Button margin='35px 0 0 95px' color='#201F1F' hover='#111111'>
        Search
