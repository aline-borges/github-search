  ...
  return(
    <Container id="listUser" direction='row' margin='5px 0' padding="10px 10px 2px" radius='10px' bgHover="#3E3C3C">
      ...
      <Container direction='column' margin='10px 0 0 0' justify='flex-start' align='flex-start'>
        ...
        <Container direction='row' margin='2px 50px 10px 0'>
          <Container direction='row'>
          <svg id='place' className="smallIcon" width="18" height="18" viewBox="0 0 23 23" fill="#8752CC" xmlns="http://www.w3.org/2000/svg">
          ...
          <Container direction='row'>
          <svg id='job' className="smallIcon" width="15" height="15" viewBox="0 0 19 18" fill="#8752CC" xmlns="http://www.w3.org/2000/svg">
