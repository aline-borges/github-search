          ...
          <Main>
            <Container id="list-repo" direction='column'>
              ...
              <Container direction='column' justify='left' align='center'>
                <Container direction='row' justify='center' align='center' margin='2px 0'>
                  <Name size='24px' weight='500' color='#F9F3F3' margin='10px 10px 0 0'>Guilherme Oliveira</Name>
                  <Username size='12px' weight='normal' color='#F9F3F3' margin='5px 0 0 0'>@guibfo</Username>
                </Container>
                <Container direction='row' margin='0 0 10px 42px'>
              ...
              <Button margin='auto' bgColor="#24927D" hover='#146A5A'>
                See More
