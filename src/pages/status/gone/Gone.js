  ...
  return(
    <Container width='100vw' height='100vh' direction='column'>
      ...
      <Content margin="120px 0 0 0" justify='center' align='center'>
        <Main>
          <Paragraph weight="800" size="24px" spacing="0.03em"> I'm not here anymore..</Paragraph>
          <Figure width='600px' src={gone} alt='gone' />
          <Paragraph weight="500" size="18px" spacing="0.03em">The requested page is permanently deleted.</Paragraph>
